...
from src.utils.toolbox_management import define_ESG_toolbox, define_econ_toolbox



AGENT_NAME = "ESG Agent"
AGENT_DESCRIPTION = "ESG Analyst for Methane & CCUS Solutions"
